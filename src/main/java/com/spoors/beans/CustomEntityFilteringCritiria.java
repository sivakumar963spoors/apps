...
public class CustomEntityFilteringCritiria {
	
	private Long customEntityFilteringCritiriaId;
	...
	public Long getCustomEntityFilteringCritiriaId() {
		return customEntityFilteringCritiriaId;
	}
	public void setCustomEntityFilteringCritiriaId(Long customEntityFilteringCritiriaId) {
		this.customEntityFilteringCritiriaId = customEntityFilteringCritiriaId;
	}

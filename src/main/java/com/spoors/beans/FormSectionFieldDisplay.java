...
public class FormSectionFieldDisplay {
	...
	private List<GenericMultiSelect> genericMultiSelects; 
	...
	public List<GenericMultiSelect> getGenericMultiSelects() {
		return genericMultiSelects;
	}
	public void setGenericMultiSelects(List<GenericMultiSelect> genericMultiSelects) {
		this.genericMultiSelects = genericMultiSelects;
	}
	...
	public String toString() {
		return "FormSectionFieldDisplay [sectionFieldSpecId="
				...
				+ ", genericMultiSelects=" + genericMultiSelects + ", visible="

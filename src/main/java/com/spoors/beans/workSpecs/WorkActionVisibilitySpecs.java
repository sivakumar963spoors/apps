...
public class WorkActionVisibilitySpecs {

	private Long id;
	private Long workSpecId;
	private Long workActionSpecId;
	private Long otherActionSpecId;
	...
	public Long getOtherActionSpecId() {
		return otherActionSpecId;
	}
	public void setOtherActionSpecId(Long otherActionSpecId) {
		this.otherActionSpecId = otherActionSpecId;
	}

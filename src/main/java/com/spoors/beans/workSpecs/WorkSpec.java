...
public class WorkSpec implements Serializable  {
	...
	private List<WorkCustomerFieldMapping> workCustomerFieldMappings;
	private Map<Long, FormFieldSpec> fieldSpecIdAndFormFieldSpecMap;
	private String includeWorkInvitations;
	private WorkDataPostingConfiguration workDataPostingConfiguration;
	private WorkSpecSchedulingConfig workSpecSchedulingConfig;
	...
	private List<WorkSpecListLevelVisibilityConfiguration> workSpecListLevelVisibilityConfiguration;
	
	private List<NotificationSpecView> NotificationSpecView;
	...
	@JsonIgnore
	public WorkSpecSchedulingConfig getWorkSpecSchedulingConfig() {
		return workSpecSchedulingConfig;
	}
	@JsonIgnore
	public void setWorkSpecSchedulingConfig(WorkSpecSchedulingConfig workSpecSchedulingConfig) {
		this.workSpecSchedulingConfig = workSpecSchedulingConfig;
	}
	@JsonIgnore
	public WorkDataPostingConfiguration getWorkDataPostingConfiguration() {
		return workDataPostingConfiguration;
	}
	@JsonIgnore
	public void setWorkDataPostingConfiguration(WorkDataPostingConfiguration workDataPostingConfiguration) {
		this.workDataPostingConfiguration = workDataPostingConfiguration;
	}
	...
	@JsonIgnore
	public List<WorkCustomerFieldMapping> getWorkCustomerFieldMappings() {
		return workCustomerFieldMappings;
	}
	@JsonIgnore
	public void setWorkCustomerFieldMappings(List<WorkCustomerFieldMapping> workCustomerFieldMappings) {
		this.workCustomerFieldMappings = workCustomerFieldMappings;
	}
	@JsonIgnore
	...
	public List<WorkSpecListLevelVisibilityConfiguration> getWorkSpecListLevelVisibilityConfiguration() {
		return workSpecListLevelVisibilityConfiguration;
	}
	public void setWorkSpecListLevelVisibilityConfiguration(
			List<WorkSpecListLevelVisibilityConfiguration> workSpecListLevelVisibilityConfiguration) {
		this.workSpecListLevelVisibilityConfiguration = workSpecListLevelVisibilityConfiguration;
	}
	...
	public List<NotificationSpecView> getNotificationSpecView() {
		return NotificationSpecView;
	}
	public void setNotificationSpecView(List<NotificationSpecView> notificationSpecView) {
		NotificationSpecView = notificationSpecView;
	}

...
public class WorkSpecSchedulingConfig {
	...
	private List<WorkInvitationCriteriaCondition> workInvitationCriteriaCondition;
    ...
    private List<WorkSpecGroupBasedAssignmentCriteria> workSpecGroupBasedAssignmentCriterias;
	...
	public List<WorkInvitationCriteriaCondition> getWorkInvitationCriteriaCondition() {
		return workInvitationCriteriaCondition;
	}
	public void setWorkInvitationCriteriaCondition(List<WorkInvitationCriteriaCondition> workInvitationCriteriaCondition) {
		this.workInvitationCriteriaCondition = workInvitationCriteriaCondition;
	}
	...
	public List<WorkSpecGroupBasedAssignmentCriteria> getWorkSpecGroupBasedAssignmentCriterias() {
		return workSpecGroupBasedAssignmentCriterias;
	}
	public void setWorkSpecGroupBasedAssignmentCriterias(
			List<WorkSpecGroupBasedAssignmentCriteria> workSpecGroupBasedAssignmentCriterias) {
		this.workSpecGroupBasedAssignmentCriterias = workSpecGroupBasedAssignmentCriterias;
	}
